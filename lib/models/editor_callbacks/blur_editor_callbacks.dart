...
class BlurEditorCallbacks extends StandaloneEditorCallbacks {
  ...
  ///
  /// This method calls the [onBlurFactorChange] callback with the provided [newFactor]
  ...
  ///
  /// This method calls the [onBlurFactorChangeEnd] callback with the provided [finalFactor]
  /// and then calls [handleUpdateUI].
