...
/// style in response to user interactions without affecting the underlying widget tree.
///
/// The [onEnter], [onExit], and [onHover] parameters allow you to handle mouse events.
